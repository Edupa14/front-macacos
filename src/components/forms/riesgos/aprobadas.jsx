...
// const FormularioAprobadas = ({ actualizarCambios, dataForm, escritura, tipo, peticion }) => {
...
//                             Descripcion Aprobada<span className="required">*</span>
//                         </Form.Label>
//                         <Col xs={12} sm={9}>
...
// export default FormularioAprobadas;